...
class Swiss(Bank):
    ...
    def __init__(self) -> None:
        ...
        self.bal=1000
    def basicinfo(self):
        print("This is Swiss Bank:",self.bal)
        return "Swiss Bank: "+str(self.bal)
    def withdraw(self,withdrawn):
        print("Withdrawal amount:",withdrawn)
        if withdrawn>self.bal:
            print("Insufficient Funds , Available Funds:",self.bal)
        else:
            self.bal=self.bal-withdrawn
